...
puts "Creating tags..."
tags = {
  breakfast:   Tag.create!(tag: "Breakfast",    color: "#d4b157", user: user),
  lunch:       Tag.create!(tag: "Lunch",         color: "#7a9d9d", user: user),
  dinner:      Tag.create!(tag: "Dinner",        color: "#577584", user: user),
  dessert:     Tag.create!(tag: "Dessert",       color: "#a67a7f", user: user),
  vegetarian:  Tag.create!(tag: "Vegetarian",    color: "#7a8f62", user: user),
  gluten_free: Tag.create!(tag: "Gluten Free",   color: "#d4b157", user: user),
  quick:       Tag.create!(tag: "Quick & Easy",  color: "#7a9d9d", user: user),
  healthy:     Tag.create!(tag: "Healthy",       color: "#7a8f62", user: user),
  comfort:     Tag.create!(tag: "Comfort Food",  color: "#b5806a", user: user),
  bbq:         Tag.create!(tag: "BBQ & Grilling", color: "#a67a7f", user: user)
}
...
NutritionFact.create!(ingredient: chicken_breast, serving_size: 100, serving_unit: "g", total_fat: 3.6, total_carb: 0, protein: 31, calories: 160)
...
NutritionFact.create!(ingredient: salmon, serving_size: 100, serving_unit: "g", total_fat: 13, total_carb: 0, protein: 20, calories: 210)
...
NutritionFact.create!(ingredient: eggs, serving_size: 50, serving_unit: "g", total_fat: 5, total_carb: 0.6, protein: 6, calories: 70)
...
NutritionFact.create!(ingredient: ground_beef, serving_size: 100, serving_unit: "g", total_fat: 15, total_carb: 0, protein: 26, calories: 250)
...
NutritionFact.create!(ingredient: bacon, serving_size: 28, serving_unit: "g", total_fat: 12, total_carb: 0.4, protein: 9, calories: 140)
...
NutritionFact.create!(ingredient: pork_chops, serving_size: 100, serving_unit: "g", total_fat: 7, total_carb: 0, protein: 26, calories: 170)
...
NutritionFact.create!(ingredient: shrimp, serving_size: 100, serving_unit: "g", total_fat: 0.3, total_carb: 0.2, protein: 24, calories: 100)
...
NutritionFact.create!(ingredient: spinach, serving_size: 100, serving_unit: "g", total_fat: 0.4, total_carb: 3.6, protein: 2.9, calories: 20)
...
NutritionFact.create!(ingredient: broccoli, serving_size: 100, serving_unit: "g", total_fat: 0.4, total_carb: 6.6, protein: 2.8, calories: 30)
...
NutritionFact.create!(ingredient: bell_pepper, serving_size: 100, serving_unit: "g", total_fat: 0.3, total_carb: 6, protein: 1, calories: 30)
...
NutritionFact.create!(ingredient: tomatoes, serving_size: 100, serving_unit: "g", total_fat: 0.2, total_carb: 3.9, protein: 0.9, calories: 20)
...
NutritionFact.create!(ingredient: garlic, serving_size: 10, serving_unit: "g", total_fat: 0.1, total_carb: 3.3, protein: 0.6, calories: 10)
...
NutritionFact.create!(ingredient: onion, serving_size: 100, serving_unit: "g", total_fat: 0.1, total_carb: 9.3, protein: 1.1, calories: 40)
...
NutritionFact.create!(ingredient: mushrooms, serving_size: 100, serving_unit: "g", total_fat: 0.3, total_carb: 3.3, protein: 3.1, calories: 20)
...
NutritionFact.create!(ingredient: potatoes, serving_size: 100, serving_unit: "g", total_fat: 0.1, total_carb: 17, protein: 2, calories: 80)
...
NutritionFact.create!(ingredient: asparagus, serving_size: 100, serving_unit: "g", total_fat: 0.1, total_carb: 3.9, protein: 2.2, calories: 20)
...
NutritionFact.create!(ingredient: banana, serving_size: 100, serving_unit: "g", total_fat: 0.3, total_carb: 22.8, protein: 1.1, calories: 90)
...
NutritionFact.create!(ingredient: blueberries, serving_size: 100, serving_unit: "g", total_fat: 0.3, total_carb: 14.5, protein: 0.7, calories: 60)
...
NutritionFact.create!(ingredient: strawberries, serving_size: 100, serving_unit: "g", total_fat: 0.3, total_carb: 7.7, protein: 0.7, calories: 30)
...
NutritionFact.create!(ingredient: lemon, serving_size: 58, serving_unit: "g", total_fat: 0.2, total_carb: 5.4, protein: 0.6, calories: 20)
...
NutritionFact.create!(ingredient: rice, serving_size: 100, serving_unit: "g", total_fat: 0.4, total_carb: 25, protein: 2.7, calories: 110)
...
NutritionFact.create!(ingredient: quinoa, serving_size: 100, serving_unit: "g", total_fat: 1.9, total_carb: 21.3, protein: 4.4, calories: 120)
...
NutritionFact.create!(ingredient: oats, serving_size: 100, serving_unit: "g", total_fat: 6.9, total_carb: 66.3, protein: 16.9, calories: 390)
...
NutritionFact.create!(ingredient: flour, serving_size: 100, serving_unit: "g", total_fat: 1, total_carb: 76, protein: 10, calories: 360)
...
NutritionFact.create!(ingredient: pasta, serving_size: 100, serving_unit: "g", total_fat: 1.5, total_carb: 75, protein: 13, calories: 370)
...
NutritionFact.create!(ingredient: bread, serving_size: 100, serving_unit: "g", total_fat: 1, total_carb: 52, protein: 8, calories: 260)
...
NutritionFact.create!(ingredient: olive_oil, serving_size: 14, serving_unit: "g", total_fat: 14, total_carb: 0, protein: 0, calories: 120)
...
NutritionFact.create!(ingredient: butter, serving_size: 14, serving_unit: "g", total_fat: 11.5, total_carb: 0.1, protein: 0.1, calories: 100)
...
NutritionFact.create!(ingredient: avocado, serving_size: 100, serving_unit: "g", total_fat: 14.7, total_carb: 8.5, protein: 2, calories: 160)
...
NutritionFact.create!(ingredient: honey, serving_size: 21, serving_unit: "g", total_fat: 0, total_carb: 17, protein: 0.1, calories: 60)
...
NutritionFact.create!(ingredient: cream, serving_size: 15, serving_unit: "ml", total_fat: 5.5, total_carb: 0.4, protein: 0.3, calories: 50)
...
NutritionFact.create!(ingredient: milk, serving_size: 240, serving_unit: "ml", total_fat: 8, total_carb: 12, protein: 8, calories: 150)
...
NutritionFact.create!(ingredient: cheese, serving_size: 28, serving_unit: "g", total_fat: 7.3, total_carb: 0.9, protein: 10, calories: 110)
...
NutritionFact.create!(ingredient: cheddar, serving_size: 28, serving_unit: "g", total_fat: 9, total_carb: 0.4, protein: 7, calories: 110)
